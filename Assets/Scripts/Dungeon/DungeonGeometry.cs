...
public static class DungeonGeometry
{
    ...
    /// spawning, so they all agree on exactly where a door sits.
    /// </summary>
    ...
    /// its center, so we add ±0.5f to actually center the door inside that wall tile.
    /// </summary>
    ...
    /// side of that connection.</summary>
